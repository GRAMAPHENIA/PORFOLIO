...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="max-w-[50rem] text-center scroll-mt-[100rem] my-10 pb-20"
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-32 w-32 rounded-[50%] object-cover border-[0.3rem] border-gray-900 shadow-xl"
            />
          </motion.div>
        </div>
      </div>
      ...
      >
        ...
        {""}
        <span className="">Construyo sitios y aplicaciones con </span>
        <span> React (Next.js)</span> y Astro.
        <span> Diseño Modelos 3D y Videojuegos</span>
      </motion.h1>
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:bg-gray-950"
          onClick={() => {
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          aria-label="Página de Linkedin de juan"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          aria-label="Página de Github de juan"
        >
